<nav class="navbar navbar-light navbar-expand bg-gray shadow mb-4 topbar static-top" style="background-color: #aeb5bf;color: rgb(255,255,255);">

<style>
    .navbar {
        height: 60px; /* atur tinggi elemen navbar */
        width: 100%; /* atur lebar elemen navbar */
        color: #ACB6BD;
    }
</style>
                ...
                src="img/undraw_profile.svg"><span class="d-none d-lg-inline mr-2 text-gray-600 small">17th database team</span></a>
                    <div
                        ...
                        <a
                            ...
                            <div class="dropdown-divider"></div><a role="presentation" class="dropdown-item" href="#"><i class="fas fa-sign-out-alt fa-sm fa-fw mr-2 text-gray-400"></i> Logout</a></div>
    </div>
    </li>
    </ul>
</nav>